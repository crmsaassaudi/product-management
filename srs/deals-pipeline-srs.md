...
- **`BR-21.3` (Ảnh chụp tính vào báo cáo theo trạng thái hiệu lực tại thời điểm chốt báo cáo, không đếm trùng qua các kỳ lồng nhau):** Một báo cáo tổng hợp cho một kỳ cụ thể (`FEAT-25`, `FEAT-26`, `FEAT-27`) chỉ tính ảnh chụp **đang có hiệu lực tại thời điểm kỳ đó kết thúc**. Áp dụng cụ thể theo hai tình huống:
